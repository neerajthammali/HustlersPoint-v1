...
// A simplified type for the stories passed from the server component
type StoryWithSlug = Story & { slug: string; };

export default function StoriesClientPage({ allStories }: { allStories: StoryWithSlug[] }) {
